...
abstract class AbstractTranslationTestCase extends TestCase
{
    ...
    public static array $locales = [
        ...
        GreekTranslationTest::class              => 'el',
        SpanishTranslationTest::class            => 'es',
        FarsiTranslationTest::class              => 'fa',
        FrenchTranslationTest::class             => 'fr',
        GujaratiTranslationTest::class           => 'gu',
        HindiTranslationTest::class              => 'hi',
        ...
        MarathiTranslationTest::class            => 'mr',
        ...
        SwahiliTranslationTest::class            => 'sw',
