...
return [
    ...
    // IncomingRequest
    'invalidNegotiationType' => '"{0}" nav derīgs sarunu veids. Jābūt vienam no šiem: media, charset, encoding, language.',
    ...
    // DownloadResponse
    'cannotSetBinary'        => 'Iestatot faila ceļu, nevar iestatīt bināro failu.',
    'cannotSetFilepath'      => 'Iestatot bināro failu, nevar iestatīt faila ceļu: "{0}"',
    ...
    'localeNotSupported' => 'Netiek atbalstīta lokāle: {0}',
    ...
    'moveFailed'   => 'Nevarēja pārvietot failu "{0}" uz "{1}". Iemesls: {2}',
