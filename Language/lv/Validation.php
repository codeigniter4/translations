...
return [
    ...
    'string'                => 'Lauka {field} vērtībai ir jābūt derīgai virknei.',
    'timezone'              => 'Lauka {field} vērtībai ir jābūt derīgai laika zonai.',
    'valid_base64'          => 'Lauka {field} vērtībai ir jābūt derīgai `base64` virknei.',
    'valid_email'           => 'Lauka {field} vērtībai ir jābūt derīgai e-pasta adresei.',
    'valid_emails'          => 'Lauka {field} vērtībai ir jābūt derīgām visām e-pasta adresēm.',
    'valid_ip'              => 'Lauka {field} vērtībai ir jābūt derīgai IP adresei.',
    'valid_url'             => 'Lauka {field} vērtībai ir jābūt derīgai URL adresei.',
    'valid_url_strict'      => 'Lauka {field} vērtībai ir jābūt derīgai URL adresei.',
    'valid_date'            => 'Lauka {field} vērtībai ir jābūt derīgam datumam.',
    'valid_json'            => 'Lauka {field} vērtībai ir jābūt derīgam JSON.',
