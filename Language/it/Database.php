...
return [
	...
	'featureUnavailable'               => 'Questa funzionalità non è disponibile per il tipo di database che stai utilizzando.',
	...
	'noDateFormat'                     => 'È necessario specificare un dateFormat valido per la classe model `{0}`',
	'fieldNotExists'                   => 'Il campo `{0}` non è stato trovato.',
	'forEmptyInputGiven'               => 'È stato fornito un valore vuoto per il campo `{0}`',
	'forFindColumnHaveMultipleColumns' => 'È possibile definire solo un elemento come nome della colonna.',
];
