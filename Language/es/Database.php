...
return [
    'invalidEvent'                     => '{0} no es unha llamada válida a un Evento de Modelo.', // '{0} is not a valid Model Event callback.',
    ...
    'emptyPrimaryKey'                  => 'No hay unha clave principal definida al intentar hacer {0}', // 'There is no primary key defined when trying to make {0}.',
    ...
    'noPrimaryKey'                     => 'La clase de modelo `{0}` no especifica unha clave primaria.', // '`{0}` model class does not specify a Primary Key.',
    ...
    'forEmptyInputGiven'               => 'Se proporciona unha declaración vacía para el campo `{0}`', // 'Empty statement is given for the field `{0}`',
    'forFindColumnHaveMultipleColumns' => 'Solo se permite unha sola columna en el nombre de la columna.', // 'Only single column allowed in Column name.',
