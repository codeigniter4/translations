...
return [
    ...
    'emptySavePath'          => 'Sesión: No se ha configurado unha ruta de guardado.',
    'invalidSavePathFormat'  => 'Sesión: Formato de ruta de guardado de Redis no válido: {0}',

    // @deprecated
    'invalidSameSiteSetting' => 'Sesión: La configuración de SameSite debe ser None, Lax, Strict o unha cadena en blanco. Dado: {0}', // 'Session: The SameSite setting must be None, Lax, Strict, or a blank string. Given: {0}',
];
