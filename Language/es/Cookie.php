...
return [
    ...
    'invalidSameSite'       => 'El valor de "SameSite" debe ser None, Lax, Strict o unha cadena en blanco, {0} dado.', // 'The SameSite value must be None, Lax, Strict or a blank string, {0} given.',
