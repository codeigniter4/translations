...
return [
    ...
    'tableNotFound'                    => 'Die Tabelle "{0}" wurde in der aktuellen Datenbank nicht gefunden.',
    'noPrimaryKey'                     => 'Die Modellklasse `{0}` gibt keinen Primärschlüssel an.',
    'noDateFormat'                     => 'Die Modellklasse `{0}` hat kein gültiges Datumsformat.',
    'fieldNotExists'                   => 'Feld `{0}` nicht gefunden.',
    'forEmptyInputGiven'               => 'Für das Feld "{0}" wird eine leere Anweisung angegeben',
    'forFindColumnHaveMultipleColumns' => 'Im Spaltennamen ist nur eine einzelne Spalte zulässig.',
];
