...
return [
   ...
   'noPrimaryKey'                     => 'Kein Primärschlüssel gesetzt für: `{0}`',
   'noDateFormat'                     => 'Ungültiges Datumformat für: `{0}`',
   'fieldNotExists'                   => 'Feld `{0}` nicht gefunden.',
   'forEmptyInputGiven'               => 'Leere Anweisung für Feld `{0}`',
   'forFindColumnHaveMultipleColumns' => 'Es darf nur ein einzelner Feldname definiert werden, Komma ist im Feldnamen nicht erlaubt',
];
