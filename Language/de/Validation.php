...
return [
    ...
    'equals'                => 'Das {field}-Formularfeld muss genau sein: {param}.',
    ...
    'is_natural_no_zero'    => 'Das {field}-Formularfeld darf nur Ziffern enthalten und muss größer al\'alpha_numeric_punct\'   => \'The {field} field may contain only alphanumeric characters, spaces, and  ~ ! # $ % & * - _ + = | : . characters.\',s Null sein.',
    ...
    'not_equals'            => 'Das {field}-Formularfeld kann nicht sein: {param}.',
