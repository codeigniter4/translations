...
return [
    ...
    'generator'          => [
        ...
        'className'       => [
            ...
            'transformer' => 'Transformer class naam',
    ...
    'signals'             => [
        'noPcntlExtension' => 'PCNTL extensie is niet beschikbaar. Signaalverwerking uitgeschakeld.',
        'noPosixExtension' => 'SIGTSTP/SIGCONT behandeling vereist POSIX extensie. Deze signalen zullen niet geregistreerd worden.',
        'failedSignal'     => 'Kan handler niet registreren voor signaal: "{0}".',
    ],
];
