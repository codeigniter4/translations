...
return [
    ...
    'invalidSMTPAuthMethod' => 'Fout: SMTP authenticatie methode "{0}" is niet ondersteund in codeigniter, gebruik "login" of "plain" als authenticatie methode',
    'failureSMTPAuthMethod' => 'Kon AUTH commando niet initialiseren. Uw server is missgien niet geconfigureerd om AUTH {0} authenticatie methode te gebruiken.',
    'SMTPAuthCredentials'   => 'Kon gebruikersgegevens niet authtenticeren. Fout: {0}',
