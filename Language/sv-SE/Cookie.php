...
return [
    'invalidExpiresTime'    => 'Felaktig typ "{0}" för "Expires" attribute. Förväntade antingen: string, integer eller DateTimeInterface objekt.',
    ...
    'invalidCookieInstance' => 'Klassen "{0}" förväntade en cookie array av typen "{1}" men fick "{2}" at index {3}.',
