...
return [
   ...
   'invalidSameSiteSetting' => '세션 : SameSite 설정은 None, Lax, Strict 또는 빈 문자열이어야합니다. 주어진 값 : {0}', // 'Session: The SameSite setting must be None, Lax, Strict, or a blank string. Given: {0}',
];
