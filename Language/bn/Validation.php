...
return [
    ...
    'field_exists'          => '{field} ফিল্ড অবশ্যই বিদ্যমান হতে হবে।', // 'The {field} field must exist.'
    ...
    'max_dims' => '{field} হয় একটি চিত্র নয়, অথবা এটি খুব চওড়া বা লম্বা৷',
    'min_dims' => '{field} হয় কোনও ছবি নয়, অথবা এটি যথেষ্ট প্রশস্ত বা লম্বা নয়।',
];
