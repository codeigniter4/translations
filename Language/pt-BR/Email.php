...
return [
    'mustBeArray'           => 'O método de validação de e-mail deve receber uma array como argumento.', // 'The email validation method must be passed an array.',
    ...
    'noFrom'                => 'Não é possível enviar e-mail sem um cabeçalho "From".', // 'Cannot send mail with no "From" header.',
    'noRecipients'          => 'Você deve incluir os destinatários: To, Cc, ou Bcc', // 'You must include recipients: To, Cc, or Bcc',
    'sendFailurePHPMail'    => 'Não foi possível enviar e-mail usando a função mail() do PHP. Seu servidor pode não estar configurado para enviar e-mails usando este método.', // 'Unable to send email using PHP mail(). Your server might not be configured to send mail using this method.',
    'sendFailureSendmail'   => 'Não foi possível enviar e-mail usando o Sendmail. Seu servidor pode não estar configurado para enviar e-mails usando este método.', // 'Unable to send email using Sendmail. Your server might not be configured to send mail using this method.',
    'sendFailureSmtp'       => 'Não foi possível enviar e-mail usando SMTP. Seu servidor pode não estar configurado para enviar e-mails por este método.', // 'Unable to send email using SMTP. Your server might not be configured to send mail using this method.',
    ...
    'noSocket'              => 'Não foi possível abrir uma conexão com o Sendmail. Verifique as configurações.', // 'Unable to open a socket to Sendmail. Please check settings.',
    ...
    'noSMTPAuth'            => 'Erro: Você precisa definir um nome de usuário e uma senha SMTP.', // 'Error: You must assign an SMTP username and password.',    
