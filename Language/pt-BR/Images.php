...
return [
    ...
    'gifNotSupported'        => 'Imagens GIF geralmente não são suportadas devido a restrições de licenciamento. Talvez seja necessário usar imagens JPG ou PNG em vez disso.',
    ...
    'libPathInvalid'         => 'O caminho para a sua biblioteca de imagens não está correto. Por favor, defina o caminho correto nas suas preferências de imagem. "{0}"',
    ...
    'invalidDirection'       => 'A direção da giro pode ser somente "vertical" ou "horizontal". Dado: "{0}"',
