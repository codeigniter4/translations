...
return [
    // Core Messages
    'noRuleSets'      => 'Nenhum conjunto de regras especificado na configuração do Validation.', // 'No rule sets specified in Validation configuration.',
    ...
    'alpha_dash'            => 'O campo {field} pode conter apenas caracteres alfanuméricos, sublinhados, e hífens.', // 'The {field} field may only contain alphanumeric, underscore, and dash characters.',
    'alpha_numeric'         => 'O campo {field} pode conter apenas caracteres alfanuméricos.', // 'The {field} field may only contain alphanumeric characters.',
    'alpha_numeric_punct'   => 'O campo {field} pode conter apenas caracteres alfanuméricos, espaços, e os caracteres ~ ! # $ % & * - _ + = | : . .', // 'The {field} field may contain only alphanumeric characters, spaces, and  ~ ! # $ % & * - _ + = | : . characters.',
    'alpha_numeric_space'   => 'O campo {field} pode conter apenas caracteres alfanuméricos e espaços.', // 'The {field} field may only contain alphanumeric and space characters.',
    ...
    'equals'                => 'O campo {field} deve ter exatamente: {param} caracteres.', // 'The {field} field must be exactly: {param}.',
    'exact_length'          => 'O campo {field} deve conter exatamente {param} caracteres no comprimento.', // 'The {field} field must be exactly {param} characters in length.',
    'field_exists'          => 'O campo {field} deve existir.', // 'The {field} field must exist.',
    ...
    'matches'               => 'O campo {field} não corresponde ao campo {param}.', // 'The {field} field does not match the {param} field.',
    'max_length'            => 'O campo {field} não pode exceder {param} caracteres.', // 'The {field} field cannot exceed {param} characters in length.',
    'min_length'            => 'O campo {field} deve conter pelo menos {param} caracteres.', // 'The {field} field must be at least {param} characters in length.',
    ...
    'required'              => 'O campo {field} é obrigatório.', // 'The {field} field is required.',
    'required_with'         => 'O campo {field} é obrigatório quando {param} está presente.', // 'The {field} field is required when {param} is present.',
    'required_without'      => 'O campo {field} é obrigatório quando {param} não está presente.', // 'The {field} field is required when {param} is not present.',
    ...
    'valid_ip'              => 'O campo {field} deve conter um endereço IP válido.', // 'The {field} field must contain a valid IP.',
    ...
    // Files
    'uploaded' => '{field} não é um arquivo enviado válido.', // '{field} is not a valid uploaded file.',
    'max_size' => '{field} é um arquivo muito grande.', // '{field} is too large of a file.',
    'is_image' => '{field} não é um arquivo de imagem enviado válido.', // '{field} is not a valid, uploaded image file.'
    'mime_in'  => '{field} não possui um tipo MIME válido.', // '{field} does not have a valid mime type.',
    'ext_in'   => '{field} não possui uma extensão de arquivo válida.', // '{field} does not have a valid file extension.',
    'max_dims' => '{field} não é uma imagem ou é muito larga ou muito alta.', // '{field} is either not an image, or it is too wide or tall.',
    'min_dims' => '{field} não é uma imagem ou não tem largura ou altura suficiente.', // '{field} is either not an image, or it is not wide or tall enough.',
];
