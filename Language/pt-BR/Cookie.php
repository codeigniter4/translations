...
return [
    ...
    'invalidSecurePrefix'   => 'Usando o prefixo "__Secure-" requer que seja definido o atributo "Secure".',
    'invalidHostPrefix'     => 'Usando o prefixo "__Host-" deve ser definido com a flag "Secure", não deve possuir o atributo "Domain", e "Path" deve ser "/".',
    'invalidSameSite'       => 'O valor de SameSite deve ser None, Lax, Strict ou uma string vazia, {0} foi passado.',
    'invalidSameSiteNone'   => 'Usando o atributo "SameSite=None" requer que seja definido o atributo "Secure".',
