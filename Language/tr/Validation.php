...
return [
    ...
    'alpha_dash'            => '{field} alanı sadece harf, rakam, alt çizgi ve tire içerebilir.',
    'alpha_numeric'         => '{field} alanı sadece harf ve rakam içerebilir.',
    'alpha_numeric_punct'   => 'The {field} field may contain only alphanumeric characters, spaces, and  ~ ! # $ % & * - _ + = | : . characters.',
    'alpha_numeric_space'   => '{field} alanı sadece harf, rakam ve boşluk içerebilir.',
    'alpha_space'           => '{field} alanı sadece harf ve boşluk içerebilir.',
    ...
    'not_equals'            => '{field} alanı şu olamaz: {param}.',
    'numeric'               => '{field} alanı sadece sayı içermeli.',
