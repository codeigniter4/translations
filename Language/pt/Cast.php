...
return [
    'baseCastMissing'        => 'A classe "{0}" deve herdar a classe "CodeIgniter\Entity\Cast\BaseCast".',
    'invalidCastMethod'      => 'O metodo "{0}" é um metodo cast invalido, os metodos validos são: ["get", "set"].',
    'invalidTimestamp'       => 'O tipo de cast "timestamp" espera uma timestamp correta.',
