...
return [
    ...
    'invalidSMTPAuthMethod' => 'Eroare: Metoda de autorizare SMTP „{0}” nu este acceptată în Codeigniter, setați fie metoda de autorizare „login”, fie „plain”.',
    'failureSMTPAuthMethod' => 'Nu se poate iniția comanda AUTH. Este posibil ca serverul dvs. să nu fie configurat să utilizeze metoda de autentificare AUTH {0}.',
    'SMTPAuthCredentials'   => 'Autentificarea credențialelor utilizatorului a eșuat. Eroare: {0}',
