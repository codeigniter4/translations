...
return [
    ...
    'invalidSMTPAuthMethod' => 'Metode autentikasi SMTP tidak valid: {0}',
    'failureSMTPAuthMethod' => 'Gagal mengirim email menggunakan metode autentikasi SMTP. Error: {0}',
    'SMTPAuthCredentials'   => 'Gagal mengautentikasi menggunakan nama pengguna dan kata sandi ini. Error: {0}',
