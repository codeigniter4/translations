...
return [
    ...
    'invalidSMTPAuthMethod' => 'Błąd: metoda autoryzacji SMTP "{0}" nie jest obsługiwana w codeigniter, ustaw metodę autoryzacji "login" or "plain".',
    'failureSMTPAuthMethod' => 'Nie można zainicjować polecenia AUTH. Twój serwer może nie być skonfigurowany do korzystania z metody uwierzytelniania AUTH {0}.',
    'SMTPAuthCredentials'   => 'Nie udało się uwierzytelnić danych użytkownika. Błąd: {0}',
