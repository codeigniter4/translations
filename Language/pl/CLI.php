...
return [
    ...
    'generator'          => [
        ...
        'className'       => [
            ...
            'transformer' => 'Nazwa klasy transformatora',
    ...
    'signals'             => [
        'noPcntlExtension' => 'Rozszerzenie PCNTL nie jest dostępne. Obsługa sygnałów wyłączona..',
        'noPosixExtension' => 'Obsługa SIGTSTP/SIGCONT wymaga rozszerzenia POSIX. Te sygnały nie będą więc rejestrowane,',
        'failedSignal'     => 'Nie udało się zarejestrować obsługi sygnału: "{0}".',
    ],
];
