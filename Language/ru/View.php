...
return [
   ...
   'missingCellParameters' => '{class}::{method} не имеет никаких параметров',
   'invalidCellParameter'  => '{0} не является допустимым именем параметра',
   'noCellClass'           => 'Класс ячейки представления не предоставлен',
   'invalidCellClass'      => 'Не удается найти класс {0} ячеек представления',
   'tagSyntaxError'        => 'У вас есть синтаксическая ошибка: {0}',
];
