...
return [
   'invalidEvent'                     => 'недопустимый обратный вызов события модели: {0}',
   'invalidArgument'                  => 'Вы должны предоставить действительный: {0}',
   'invalidAllowedFields'             => 'Допустимые поля должны быть указаны для модели: {0}',
   ...
   'parseStringFail'                  => 'Не удалось выполнить синтаксический анализ строки ключа',
   'featureUnavailable'               => 'Эта функция недоступна для используемой базы данных',
   'tableNotFound'                    => 'Таблица: {0} небыла найдена в текущей базе данных',
   'noPrimaryKey'                     => 'В классе: {0} не указан первичный ключ',
   'noDateFormat'                     => 'В классе: {0} не указан $dateFormat',
