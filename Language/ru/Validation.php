...
return [
   ...
   'decimal'               => 'Поле {field} межет содержать только десятичное число',
   ...
   'valid_date'            => 'Поле {field} должно содержать допустимую дату',
	...
	// Credit Cards
   'valid_cc_num'          => '{поле} не является действительным номером кредитной карты',

	// Files
   'uploaded'              => '{поле} не является допустимым загруженным файлом',
   'max_size'              => '{поле} слишком большое для файла',
   'is_image'              => '{поле} не является допустимым загруженным файлом изображения',
   'mime_in'               => '{поле} не имеет допустимый тип файла',
   'ext_in'                => '{поле} не имеет допустимое расширение файла',
   'max_dims'              => '{поле} либо не является изображением, либо оно слишком широкое или высокое',
];
