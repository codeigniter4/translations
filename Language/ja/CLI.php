...
return [
	...
	// Generators
	'generateClassName'   => 'クラス名', //Name of class
	'generateParentClass' => '拡張する親クラス名', //Name of parent class to extend from
	'generateFileExists'  => '{0} は存在します。', //{0} already exists.
	'generateFileSuccess' => '作成されたファイル: ', //Created file:
	'generateFileError'   => 'ファイル作成エラー: ', //Error in creating file:
