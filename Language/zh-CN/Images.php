...
return [
    ...
    'jpgOrPngRequired'       => 'The image resize protocol specified in your preferences only works with JPEG or PNG image types.',  // not used
    'rotateUnsupported'      => 'Image rotation does not appear to be supported by your server.',  // not used
    ...
    'copyFailed'             => 'The image copy routine failed.', // not used
    'missingFont'            => 'Unable to find a font to use.', // not used
