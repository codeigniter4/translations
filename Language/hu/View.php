...
return [
    'invalidCellMethod'     => '{class}::{method} nem érvényes metódus.',
    'missingCellParameters' => '{class}::{method} nincs paramétere.',
    'invalidCellParameter'  => '{0} nem érvényes paraméternév.',
